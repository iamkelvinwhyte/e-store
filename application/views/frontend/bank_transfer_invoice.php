...
<!-- Mirrored from coderthemes.com/hyper/modern/pages-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Sep 2020 03:22:45 GMT -->
...
<head>
    ...
    <body class="loading" data-layout="detached" data-layout-config='{"leftSidebarCondensed":false,"darkMode":false, "showRightSidebarOnStart": true}' ng-app="myStore" ng-controller="StoreCtrl">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="float-left mt-3">
                                                    <p ng-repeat="t in trans_obj"><b>O. Miracle Godspeed</b></p>
        ...
        <!-- bundle -->
        <script src="<?=base_url()?>assets/transactions/js/vendor.min.js"></script>
        <script src="<?=base_url()?>assets/transactions/js/app.min.js"></script>
        
    </body>

<!-- Mirrored from coderthemes.com/hyper/modern/pages-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Sep 2020 03:22:46 GMT -->
</html>
