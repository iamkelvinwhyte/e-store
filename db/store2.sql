...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2021 at 08:34 PM
...
CREATE TABLE `currency` (
  `id` int(25) NOT NULL,
  `name` varchar(25) CHARACTER SET latin1 COLLATE latin1_danish_ci NOT NULL,
  `shortname` varchar(25) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
INSERT INTO `currency` (`id`, `name`, `shortname`, `symbol`, `active`) VALUES
(1, 'Naira', 'NGN', 'N', 1),
(2, 'US Dollar', 'USD', '$', 0);
...
CREATE TABLE `user_order` (
  ...
  `delivery_address` varchar(500) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `phone` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `payment_method_id` int(25) NOT NULL,
  `invoice_number` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `country_id` int(25) NOT NULL,
  `town/city` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user_order` (`id`, `user_id`, `fullname`, `delivery_address`, `email`, `phone`, `payment_method_id`, `invoice_number`, `country_id`, `town/city`) VALUES
(7, 0, 'Miracle Godspeed', 'Enugu', 'miracle@mail.com', '09087654353', 0, 'MG3245443', 1, 'Enugu'),
(8, 0, 'Nwankwo Nkechi', 'Enugu', 'nkechi@mail.com', '09083738473', 0, 'MG3245443', 1, 'Enugu'),
(14, 0, 'Ugo Nwabunike', 'Enugu', 'ugo@mail.com', '09087968686', 1, 'MG3245443', 1, 'Enugu'),
(19, 0, 'Nwankwo Nkechi', 'Delta', 'nkechi@mail.com', '454532245', 1, 'MG3245443', 1, 'Enugu'),
(21, 0, 'Gabriel Martins', 'Delta', 'gab@mail.com', '0908384743', 1, '0', 1, 'Delta');
...
ALTER TABLE `user_order`
  ADD PRIMARY KEY (`id`),
  ADD KEY `payment_method_order1` (`payment_method_id`),
  ADD KEY `country_user_order1` (`country_id`);
...
ALTER TABLE `user_order_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `all_order_user_order` (`user_order_id`);
