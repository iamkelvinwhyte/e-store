...
<div class="site-main clearfix" ng-app="myStore" ng-controller="StoreCtrl" ng-init="show_countries()" ng-cloak>
    <div class="container">
        <div class="row">
                                            ...
                                            <td class="product">
                                              ...
                                              <td  class="product">
                                                  <span class="Price-amount">
                                                      ...
                                                      <span><span ng-repeat="c in active_currency">{{c.symbol}}</span>  {{item.cost   | currency : "" }}</span>
                                                  </span>
                                              </td>
                                          </tr>
                                      ...
                                      <tfoot>
                                          <tr class="cart-subtotal">
                                              ...
                                              <td>
                                                  <span class="Price-amount">
                                                      <span class="Price-currencySymbol"></span>
                                                      <span ng-repeat="c in active_currency">{{c.symbol}}</span>{{invoiceSubTotal() | currency : "" }}
                                                  </span>
                                              </td>
                                          </tr>
                            ...
                            <div class="col-2 " >
                                <div class="billing-fields">
                                    ...
                                    <p class="form-row">
                                        ...
                                        <input type="email" class="input-text" name="billing_Email_Address" id="billing_Email_Address" placeholder=" Email Address" value="<?=$this->session->userdata('email')?>"/>
                                    </p>
                                    <p class="form-row">
                                     ...
                                     <!-- <option ng-repeat="z in get_countries" value="{{z.id}}"> {{z.name}}</option> -->
                                    </select>
                                     </div>
                                    ...
                                    <p class="form-row">
                                        ...
                                        <input type="text" class="input-text" ng-model="billing_Postcode" id="billing_Postcode" placeholder=" Postcode" value="<?=$this->session->userdata('post_code')?>"/>
                                    </p>
                                </div>
                                <div class="shipping-fields">
                                    ...
                                    <p class="form-row">
                                        ...
                                        <textarea type="text" class="input-text" ng-model="Ship_Order_Notes" id="Ship_Order_Notes" placeholder=" Order Notes"></textarea>
                                    </p>
                                </div>
                                ...
                                <div class="checkout-review-order">
                                    ...
                                    <div class="checkout-payment">
                                        <ul class="payment_methods">
                                            <li class="payment_method payment_method_transfer_banck">
                                                <input type="radio" class="input-checkbox" checked name="payment-method" id="payment_method_transfer_banck" value="1"/>
                                                <label for="payment_method_transfer_banck">
                                                        Direct bank Transfer
                                                </label>
                                            </li>
                                            <li class="payment_method payment_method-cheque">
                                                <input type="radio" class="input-radio" name="payment-method" id="payment_method-cheque" value="2"/>
                                    ...
                                    <!-- <input type="button" class="button" ng-click="add_checkout_info()" value="submit"/> -->
                                    <!-- <input type="submit" class="button" ng-click="add_checkout_info()"/> -->
                                     <button type="button" class="btn btn-success" ng-click="add_checkout_info()" style="width:100%!important">Submit</button>
