            ...
            <div class="nav-right col">
                <ul class="nav-menus">
                    <li>
                        <form class="form-inline search-form">
                            <div class="form-group">
                                <input class="form-control-plaintext" type="text" placeholder="Search..."><span class="d-sm-none mobile-search" ng-model="product_search"><i data-feather="search"></i></span>
                            </div>
                        </form>
                    </li>
                    ...
                    <li class="onhover-dropdown">
                        <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="<?=base_url()?>assets/backend/images/dashboard/man.png" alt="header-user">
