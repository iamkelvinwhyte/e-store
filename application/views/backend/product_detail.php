                                ...
                                <div class="add-product">
                                    <div class="row">
                                        <div class="col-xl-9 xl-50 col-sm-6 col-9">
                                          <div class="row">
                          <div class="col-md-6">  <img src="<?=base_url()?>uploads/<?=$data_product->file?>"  id="myImg"  alt="" class="img-fluid"></div>
                          <div class="col-md-6">  <img src="<?=base_url()?>uploads/<?=$data_product->file_1?>"  id="myImg_1"  alt="" class="img-fluid "></div>
                          <div class="col-md-6">  <img src="<?=base_url()?>uploads/<?=$data_product->file?><?=base_url()?>uploads/<?=$data_product->file_2?>"  id="myImg_2"  alt="" class="img-fluid "></div>
                          <div class="col-md-6">  <img src="<?=base_url()?>uploads/<?=$data_product->file_3?>"  id="myImg_3"  alt="" class="img-fluid "></div>
                          <div class="col-md-6">  <img src="<?=base_url()?>uploads/<?=$data_product->file?><?=base_url()?>uploads/<?=$data_product->file_4?>"  id="myImg_4"  alt="" class="img-fluid "></div>
                          <div class="col-md-6">  <img src="<?=base_url()?>uploads/<?=$data_product->file_5?>"  id="myImg_5"  alt="" class="img-fluid "></div>
                            ...
                            <div class="col-xl-7">
                                <form class="needs-validation add-product-form" novalidate="">
                                    ...
                                    <div class="offset-xl-3 offset-sm-4">
                                        <button type="submit" class="btn btn-success" ng-click="add_update_product()">Update</button>
...
Stock.controller("StoreCtrl", function($scope, $http) {
  ...
  $scope.qty=1
  $scope.title="<?=$data_product->title?>"
  $scope.price="<?=$data_product->price?>"
  $scope.discount="<?=$data_product->discount?>"
  $scope.qty="<?=$data_product->qty?>"
  $scope.color="<?=$data_product->color?>"
  $scope.size="<?=$data_product->size?>"
  $scope.cate_name="<?=$data_product->category_id?>"
  $scope.descrip="<?=$data_product->descrip?>"
  $scope.product_code="<?=$data_product->product_code?>"
  ...
  $scope.add_update_product  = function() {
    ...
    fd.append('product_code',$scope.product_code);
    ...
    if($scope.qty==null){
      ...
      $http({
        method: 'post',
        url: "<?=base_url()?>main/upload_update_product",
        data: fd,
        ...
        if ($scope.response ){
          swal("successful!", "You update has been completed!", "success");
          $scope.show_data();
        } else {
