  ...
  <div class="shop-product-list shop-product-list-2-columns clearfix col-sm-12">
    ...
    <div class="row">
      <ul class="products clearfix">
        <!--Product 1-->
        <li class="col-sm-4 col-xs-4 product " style="height:700px;" data-category="all,{{x.sub_name}}" dir-paginate="x in get_all_product|orderBy:sortKey:reverse|filter:product_search|itemsPerPage:20">
