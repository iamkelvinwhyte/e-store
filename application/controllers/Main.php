...
{
  $this->load->view('backend/miracle.php');
}
...
public function get_new_products(){
  $fetch_data = $this->Homepage_model->single_query('product',['status'=>'1'], 'product_id');
  $presenter = $fetch_data->result_array();
  $this->output->set_output(json_encode($presenter));
}
