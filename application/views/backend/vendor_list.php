        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="btn-popup pull-right">
                <a href="<?=base_url()?>main/vendor_create" class="btn btn-info">Create Vendor</a>
            </div>
            <div class="btn-popup pull-right">
              ...
              <div class="user-status table-responsive latest-order-table">
                <table class="table table-bordernone">
                  ...
                  <tbody dir-paginate="x in getdata|orderBy:sortKey:reverse|filter:userSearch|itemsPerPage:20">
                    ...
                    <td > <a  href="<?=base_url()?>main/vendor_detail/{{x.institution_id}}" class="btn-sm btn-info" type="button" >edit</a>- <button class="btn-sm btn-primary" type="button"  ng-click="delete_page(x.institution_id)">delete</button>
                    </td>
                    </tr>
...
Stock.controller("StoreCtrl", function($scope, $http) {
  ...
  $scope.show_data = function() {
    $http.get("<?=base_url()?>main/get_vendor")
  ...
  $scope.lock_page = function(personal_info_id,status) {
    if (confirm("Are you sure you want to perform this action? ")) {
      ...
      $http.post("<?=base_url()?>main/lock_vendor", {
  ...
  $scope.delete_page = function(institution_id) {
    if (confirm("Are you sure you want to perform this action?")) {
        $("#preloader").fadeIn(800);
      $http.post("<?=base_url()?>main/delete_vendor", {
