...
<head>
    ...
    <!-- slick icon-->
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/backend/css/slick.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/backend/css/slick-theme.css">

    <!-- jsgrid css-->
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/backend/css/jsgrid.css">

    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/backend/css/bootstrap.css">

    <!-- App css-->
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/backend/css/admin.css">
                            ...
                            <div class="tab-content" id="top-tabContent">
                              ...
                              ?>
                                ...
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" action="<?=base_url()?>auth/activ_login_admin" method="POST">
                                        <div class="form-group">
                                            <input required="" name="email" type="text" class="form-control" placeholder="Email or Phone" required>
                                        </div>
                                        <div class="form-group">
...
<script src="<?=base_url()?>assets/backend/js/slick.js"></script>

<!-- Jsgrid js-->
<script src="<?=base_url()?>assets/backend/js/jsgrid/jsgrid.min.js"></script>
<script src="<?=base_url()?>assets/backend/js/jsgrid/griddata-invoice.js"></script>
<script src="<?=base_url()?>assets/backend/js/jsgrid/jsgrid-invoice.js"></script>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Jan 2021 15:52:42 GMT -->
</html>
